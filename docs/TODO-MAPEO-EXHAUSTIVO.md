...
- [ ] Las 1.754 posiciones partidistas inventariadas alcanzan cita/localizador y fecha suficientes según el contrato final; una URL al documento completo no cuenta como pasaje reproducible y cualquier alta posterior actualiza de forma explícita este total.
