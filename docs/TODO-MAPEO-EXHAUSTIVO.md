...
- [ ] Recuperación restante del presupuesto inicial: tope 130→126 aplicado (suelo medido 125,2; el crecimiento fue contenido —glosario 78, banco 414, motor conjuntivo—, no fuga); volver a ≤120 exige la palanca del glosario perezoso tras el primer «?» (~2,5 KiB, rehaciendo su contrato E2E) o una poda de contenido que decide el propietario; ningún tope se sube dos veces seguidas sin un bloque de recuperación ejecutado entre medias.
