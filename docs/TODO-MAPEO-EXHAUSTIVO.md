...
- [ ] Poblar el cuadrante de corrientes doctrinales (hoy 18 de 61 dibujadas en el plano Economía×Sociedad) con más ideologías con evidencia trazable, mejorando su claridad; toda ampliación **añade** corrientes y legibilidad, nunca reduce (ver norma dura del atlas ideológico en «Reglas de cierre»).
...
- [ ] La vista de profundidad es el **estado por defecto**: «Incluir corrientes de profundidad» va activado de entrada y el cuadrante rico (Economía×Sociedad con todas las corrientes y partidos) se muestra desplegado sin exigir un clic. La norma dura prohíbe esconderlo tras la vista por defecto.
- [ ] La **vista simple** es un political compass pelado —ejes, cuadrantes, tu punto y los partidos, sin la capa densa de corrientes— ofrecido como alternativa ligera conmutable, nunca como sustituto de la vista de profundidad.
...
- [ ] Las 1.357 posiciones partidistas inventariadas alcanzan cita/localizador y fecha suficientes según el contrato final; una URL al documento completo no cuenta como pasaje reproducible y cualquier alta posterior actualiza de forma explícita este total.
