...
- [x] Transferencia adicional de Resultados y catálogos ≤390 KiB gzip, sin ocultar fuentes ni perfiles para aprobar (tope recuperado el 2026-07-13 tras hacer perezoso el catálogo doctrinal del cruce mapa↔doctrina: medido 328,7).
- [x] Recuperación del presupuesto inicial completada (2026-07-13): la palanca del glosario perezoso con prefetch se ejecutó al crecer el catálogo a 96 términos y el cierre inicial queda en 107,2 KiB medidos con el tope restaurado a ≤120; sigue vigente la regla de que ningún tope se sube dos veces seguidas sin un bloque de recuperación ejecutado entre medias.
...
- [ ] Las 1.643 posiciones partidistas inventariadas alcanzan cita/localizador y fecha suficientes según el contrato final; una URL al documento completo no cuenta como pasaje reproducible y cualquier alta posterior actualiza de forma explícita este total.
