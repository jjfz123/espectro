...
| ELEC-001 | P0 | Electoral | `scripts/auditar-contexto-electoral.mjs`: recorre 21 convocatorias, falla cerrado (IDs, territorios, duplicados, foráneas, relaciones) | — | Fable/Sonnet | scripts/auditar-contexto-electoral.mjs, package.json | fixtures + ejecución | en revisión | subagente en worktree agent/elec-auditor (base 8bbb057); pendiente de integrar |
| ELEC-002 | P0 | Electoral | Tests parametrizados de contención territorial para TODAS las convocatorias incl. Ceuta y Melilla | ELEC-001 | Fable/Sonnet | tests/ | unit | en revisión | ídem ELEC-001 |
...
| UX-002 | P1 | Resultados | Brújula principal de carga inmediata sin Three.js ni atlas pesado; alternar conjuntos de puntos | UX-001 | Fable | web/src | budget + E2E | pendiente | diseño anotado: partir mapaEspacial en módulo ligero solo-partidos sin arrastrar datosReferencias; no intentado para no duplicar metodología |
