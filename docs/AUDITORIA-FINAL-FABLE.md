...
Workflow independiente (4 dimensiones: motor, metodología, persistencia, UX/orden) con verificación por refutación de cada hallazgo. Resultado del triaje: se documenta al cierre en esta sección.
